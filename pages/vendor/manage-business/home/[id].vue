...
<template #right>
        ...
        <section class="">
            ...
            <div class="flex items-center w-full card mb-2">
                ...
                <Image :src="resBusinessAll?.business_img" alt="Image" width="50"
                ...
                <div v-for="(item, index) in resBusinessAll?.business_list" :key="index"
                    ...
                    <div class="p-3">
                        ...
                        <div class="flex justify-between items-center">
                            <h2 class="text-lg font-semibold text-gray-800">{{ getI18n(item?.business_list_name_i18n, locale)
                                }}</h2>
...
import { LayoutsBaseHeader } from '#components';
...
const DeleteItems = async () => {
    try {
        const res = await dataApi.deleteBusinessId(itemForDelete.value.id);
        alertToast.value = {
            title: t('สำเร็จ'),
            color: 'info',
            isError: false,
